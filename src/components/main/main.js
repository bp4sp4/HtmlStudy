    ...
    <div className={styles.container}>
      ...
      <main className={styles.main__wrap}>
        ...
        <section className={styles.section}>
          ...
          <p>
            처음 접하는 <code className={styles.code}>&lt;HTML&gt;</code> 태그들
            직관적으로 쉽게 이해 가능하게 작성하기
          </p>
        </section>
        <section className={styles.section}>
          ...
          <p>
            ...
            <code className={styles.code}>&lt;HTML&gt;</code> 기본태그들 이해가
            가능하다.
          </p>
        </section>
        <section className={styles.section}>
          <a className={styles.main__start__btn} href="/heading/heading">
